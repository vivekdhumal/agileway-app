        ...
        <>
            <Layout>
                ...
                <div className="flex justify-between items-baseline">
                    ...
                    <Link href="/users/create" className="px-4 py-2 bg-indigo-500 text-white rounded-md">Create New</Link>
                </div>
                    ...
                    {props.users.map(user => (
                        <tr key={user.id}>
                            ...
                            <td className="py-2 px-4 border-b text-right">
                                <Link href={`/users/${user.id}/edit`} className="px-4 py-2 bg-indigo-500 text-white rounded-md mr-2">Edit</Link>
